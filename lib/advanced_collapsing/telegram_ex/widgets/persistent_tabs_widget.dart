...
class PersistentTabsWidget extends StatefulWidget {
  const PersistentTabsWidget({super.key});

  @override
  PersistentTabsWidgetState createState() => PersistentTabsWidgetState();
}

class PersistentTabsWidgetState extends State<PersistentTabsWidget>
